 ...
 */
function saveSessionToFile(id = null) {
    try {
...
async function keepAlive() {
    ...
    keepAliveInterval = setInterval(async () => {
        try {
            ...
            if (!res.ok)
                throw new Error(`KeepAlive failed with status ${res.status}`);
...
export { saveSessionToFile, getSession, keepAlive, stopKeepAlive, isDocker, getIp, };
